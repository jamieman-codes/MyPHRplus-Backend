...
public class ABE {
    ...
    /**
     * Delegates a new private key given a private key and a subset of its
     * attributes
     * 
     * @param pub  Public Key
    ...
    /**
     * Encrypts a file based upon the policy specifed. Example policy: foo bar fim
     * 2of3 baf 1of2 This is read as (((foo bar fim) 2of3) baf 1of2) This means a
     * user either needs 2 of foo, bar, fim OR baf as attributes in order to decrypt
     * 
    ...
    /**
     * Encrypts or Decrypts a file using AES, generating an AES Key using a ABE
     * Ciphertext as a seed
     * 
